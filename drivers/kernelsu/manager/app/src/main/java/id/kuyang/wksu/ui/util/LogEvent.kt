package id.kuyang.wksu.ui.util

import android.content.Context
import android.os.Build
import android.system.Os
import id.kuyang.wksu.Natives
import id.kuyang.wksu.ui.screen.getManagerVersion
...
fun getBugreportFile(context: Context): File {
    ...
    Shell.cmd("tar -czf ${opulsFile.absolutePath} -C /mnt/oplus/op2/media/log/boot_log/ .").exec()
